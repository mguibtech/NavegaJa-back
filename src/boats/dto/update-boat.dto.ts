...
export class UpdateBoatDto {
  ...
  @ApiPropertyOptional({
    example:
      'https://storage.googleapis.com/navegaja.appspot.com/boats/uuid.jpg',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    ...
    description:
      'Fotos do barco (exterior, interior) — URLs do Firebase Storage',
  })
  @IsOptional()
  @IsArray()
  ...
  @ApiPropertyOptional({
    type: [String],
    example: [
      'https://storage.googleapis.com/...licenca.jpg',
      'https://storage.googleapis.com/...vistoria.jpg',
    ],
    description:
      'Fotos de documentos do barco (licença de navegação, certificado de vistoria, etc.)',
  })
  @IsOptional()
  @IsArray()
  @IsUrl({ require_tld: false }, { each: true })
  ...
  @ApiPropertyOptional({
    example: 'AM-1234',
    description: 'Número de registro da embarcação',
  })
  @IsOptional()
  @IsString()
