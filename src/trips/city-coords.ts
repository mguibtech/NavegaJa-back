...
export const AMAZON_CITY_COORDS: Record<string, { lat: number; lng: number }> = {
  ...
  'anori':             { lat: -3.7667,  lng: -61.6500 },
  'alvaraes':          { lat: -3.2167,  lng: -64.8000 },
  'alvarães':          { lat: -3.2167,  lng: -64.8000 },
  'tefe':              { lat: -3.3500,  lng: -64.7167 },
  'tefé':              { lat: -3.3500,  lng: -64.7167 },
  'uarini':            { lat: -2.9833,  lng: -65.1333 },
  'coari':             { lat: -4.0833,  lng: -63.1333 },
  'codajas':           { lat: -3.8333,  lng: -62.1000 },
  'codajás':           { lat: -3.8333,  lng: -62.1000 },
  'anamari':           { lat: -3.7000,  lng: -61.5000 },
  'caapiranga':        { lat: -3.3333,  lng: -61.2000 },
  'jutai':             { lat: -2.7500,  lng: -66.7833 },
  'jutaí':             { lat: -2.7500,  lng: -66.7833 },
  'fonte boa':         { lat: -2.5000,  lng: -66.0833 },
  'tonyamais':         { lat: -2.7500,  lng: -67.0000 },
  'amatura':           { lat: -3.3667,  lng: -68.2500 },
  'sao paulo de olivenca': { lat: -3.4500, lng: -68.9167 },
  'são paulo de olivença': { lat: -3.4500, lng: -68.9167 },
  'tabatinga':         { lat: -4.2500,  lng: -69.9333 },
  'benjamin constant': { lat: -4.3833,  lng: -70.0333 },

  // ── Rio Amazonas / corredor leste ─────────────────────────────────────────
  'itacoatiara':       { lat: -3.1430,  lng: -58.4444 },
  ...
  'urucara':           { lat: -2.5333,  lng: -57.7500 },
  'urucurituba':       { lat: -2.7000,  lng: -57.7500 },
  'silves':            { lat: -2.8333,  lng: -58.2000 },
  'sao sebastiao do uatuma': { lat: -2.5500, lng: -57.8833 },
  'são sebastião do uatumã': { lat: -2.5500, lng: -57.8833 },
  'boa vista do ramos': { lat: -2.9833, lng: -57.5667 },
  'nhamunda':          { lat: -2.1833,  lng: -56.7167 },
  'oriximina':         { lat: -1.7667,  lng: -55.8667 },
  'obidos':            { lat: -1.9000,  lng: -55.5167 },
  'óbidos':            { lat: -1.9000,  lng: -55.5167 },
  ...
  // ── Rio Madeira / sul ─────────────────────────────────────────────────────
  'manicore':          { lat: -5.8167,  lng: -61.3000 },
  'humaita':           { lat: -7.5000,  lng: -63.0167 },
  'humaitá':           { lat: -7.5000,  lng: -63.0167 },
