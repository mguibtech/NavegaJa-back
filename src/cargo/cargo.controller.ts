...
export class CargoController {
  ...
  create(@Request() req: AuthenticatedRequest, @Body() dto: CreateCargoDto) {
  ...
  findMyCargo(@Request() req: AuthenticatedRequest) {
  ...
  deliver(
    @Param('id') id: string,
    @Request() req: AuthenticatedRequest,
    @Body() body: { deliveryPhotoUrl?: string },
  ) {
