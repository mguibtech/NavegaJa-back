...
export class Coupon {
  ...
  @Column({
    ...
    length: 100,
    nullable: true,
    comment: 'Filtro: cidade de origem (null = todas)',
  })
  ...
  @Column({
    ...
    length: 100,
    nullable: true,
    comment: 'Filtro: cidade de destino (null = todas)',
  })
  toCity: string | null;
  ...
  @Column({
    ...
    scale: 2,
    nullable: true,
    comment: 'Peso mínimo em kg para encomendas (null = sem mínimo)',
  })
  ...
  @Column({
    ...
    scale: 2,
    nullable: true,
    comment: 'Peso máximo em kg para encomendas (null = sem máximo)',
  })
