...
export class ReviewsController {
  ...
  @ApiOperation({
    ...
    description:
      'Submete uma avaliação com estrelas e comentários para o capitão e (opcionalmente) para o barco. Só permitido após viagem CONCLUÍDA.',
  })
  @ApiResponse({ status: 201, description: 'Avaliação criada com sucesso' })
  @ApiResponse({
    status: 400,
    description: 'Viagem não concluída ou já avaliada',
  })
  @ApiResponse({
    status: 403,
    description: 'Passageiro não participou desta viagem',
  })
  ...
  @ApiOperation({
    ...
    description:
      'O capitão da viagem avalia um passageiro. Só permitido após viagem CONCLUÍDA.',
  })
  ...
  @ApiResponse({
    status: 403,
    description: 'Utilizador não é capitão desta viagem',
  })
  createCaptainReview(
    @Request() req: AuthenticatedRequest,
  ...
  @ApiOperation({
    ...
    description:
      'Retorna se o utilizador pode avaliar a viagem e o motivo. Útil para mostrar/esconder o botão de avaliação no app.',
  })
  canReview(
    @Request() req: AuthenticatedRequest,
  ...
  @ApiOperation({
    ...
    description:
      'Retorna todas as avaliações recebidas por um capitão, com stats (média e distribuição de estrelas).',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Retorna todas as avaliações recebidas por um barco, com stats.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Retorna todas as avaliações que um passageiro recebeu de capitães.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Retorna todas as avaliações (passageiro→capitão/barco e capitão→passageiros) de uma viagem.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Retorna todas as avaliações que o utilizador autenticado escreveu.',
  })
