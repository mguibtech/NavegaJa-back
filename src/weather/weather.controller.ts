...
export class WeatherController {
  ...
  @ApiOperation({
    ...
    description:
      'Retorna condições meteorológicas atuais incluindo nascer/pôr do sol (cache 30min)',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Regiões disponíveis: manaus, parintins, santarem, itacoatiara, manacapuru',
  })
  ...
  @ApiQuery({
    ...
    required: false,
    example: 5,
    description: 'Número de dias (máx 7, padrão 7)',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Analisa condições climáticas e retorna score 0-100 com avisos e recomendações',
  })
  @ApiQuery({ name: 'lat', required: true, example: -3.119 })
  @ApiQuery({ name: 'lng', required: true, example: -60.0217 })
  async evaluateNavigationSafety(
    ...
    return this.weatherService.evaluateNavigationSafety(
      parseFloat(lat),
      parseFloat(lng),
    );
  }
  ...
  @ApiOperation({
    ...
    description:
      'Retorna clima actual, score de segurança e avisos para a origem da viagem',
  })
    ...
    schema: {
      example: {
        ...
        weather: {
          ...
          condition: 'Nublado',
          windSpeed: 4.2,
          sunrise: '2026-02-26T09:45:00.000Z',
          sunset: '2026-02-26T21:52:00.000Z',
        },
  ...
  @ApiOperation({
    ...
    description:
      'Retorna nível actual (cm) dos rios nas principais cidades — fonte: ANA (cache 1h)',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Estações: 14100000 (Manaus), 13850001 (Parintins), 14320000 (Itacoatiara), 14110000 (Manacapuru)',
  })
  ...
  @ApiQuery({
    ...
    required: false,
    example: 50,
    description: 'Raio em km (padrão 50)',
  })
  ...
  @ApiParam({
    name: 'gaugeId',
    description: 'ID da estação Flood Hub',
    example: 'hybas_1120584700',
  })
  ...
  @ApiQuery({
    ...
    required: false,
    example: 7,
    description: 'Número de dias (padrão 7, máx 7)',
  })
  ...
  @ApiQuery({
    ...
    required: false,
    example: 500,
    description: 'Raio em km (padrão 500)',
  })
